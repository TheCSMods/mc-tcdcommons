...
public final class TextUtils
{
	...
	// ==================================================
	/**
	 * Returns a literal {@link MutableText} using the given {@link String} argument.
	 * @param text The literal text.
	 */
	public static MutableText literal(String text) { return Text.literal(text); }
	 ...
	 * @param params The translatable {@link Text} formatting parameters.
	 */
