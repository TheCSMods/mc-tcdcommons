...
public final @Internal class TCDCommonsNetwork
{
	...
	//
	public static final Identifier S2C_PLAYER_BADGES = Identifier.of(getModID(), "player_badges");
	//
	public static final Identifier S2C2C_FCPNP = Identifier.of(getModID(), "f"); //fractured CPN packet
	//^ fractured CPN packets divide a single large CPN packet into several smaller ones
	// ==================================================
	public static final void init() {}
	static
	{
		//register TCDCommons's Custom Payload (CPN) to the game's vanilla registry
