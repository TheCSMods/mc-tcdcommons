...
public abstract class CachedResourceSerializer<T>
{
	...
	static
	{
		...
		CACHED_RESOURCE_SERIALIZER.register(
			Identifier.of(modId, String.class.getName().toLowerCase().replace('.', '/')),
		...
		//byte[]
		CACHED_RESOURCE_SERIALIZER.register(
			Identifier.of(modId, "byte_array"),
		...
		//JsonObject
		CACHED_RESOURCE_SERIALIZER.register(
			Identifier.of(modId, JsonObject.class.getName().toLowerCase().replace('.', '/')),
		...
		//JsonArray
		CACHED_RESOURCE_SERIALIZER.register(
			Identifier.of(modId, JsonArray.class.getName().toLowerCase().replace('.', '/')),
