...
public @Virtual class TSliderWidget extends TButtonWidget
{
	...
	public TSliderWidget(int x, int y, int width, int height, Text text, double value)
	{
	...
	{
		pencil.drawGuiTexture(RenderPipelines.GUI_TEXTURED, BUTTON_TEXTURES.get(this.enabled, isFocusedOrHovered()), knobX, knobY, knobWidth, knobHeight);
	}
	// ==================================================
