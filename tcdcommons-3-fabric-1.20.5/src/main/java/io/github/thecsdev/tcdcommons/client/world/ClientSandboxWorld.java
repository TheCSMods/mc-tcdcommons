...
public @Virtual class ClientSandboxWorld extends World
{
	...
	public ClientSandboxWorld()
	{
		...
		this.recipeManager = new RecipeManager(new WrapperLookup()
		{
			public Stream<RegistryKey<? extends Registry<?>>> streamAllRegistryKeys() { return Stream.empty(); }
			public <T> Optional<Impl<T>> getOptionalWrapper(RegistryKey<? extends Registry<? extends T>> registryRef) { return Optional.empty(); }
		});
	...
	public final @Override MapIdComponent getNextMapId() { return new MapIdComponent(0); }
