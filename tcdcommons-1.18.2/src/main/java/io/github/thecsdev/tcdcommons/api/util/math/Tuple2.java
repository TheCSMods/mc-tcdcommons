...
public class Tuple2<T1, T2>
{
	 ...
	 */
	public void clear() { this.Item1 = null; this.Item2 = null; }
	
	/**
	 * Returns true if all item's values are set to null.
	 */
	public boolean isCleared() { return this.Item1 == null && this.Item2 == null; }
	
	/**
	 * Returns true if all item's values are <b>not</b> set to null.
	 */
	public boolean isFull() { return this.Item1 != null && this.Item2 != null; }
}