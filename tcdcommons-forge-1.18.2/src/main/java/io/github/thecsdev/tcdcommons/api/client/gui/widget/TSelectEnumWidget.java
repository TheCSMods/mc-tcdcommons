...
public class TSelectEnumWidget<T extends Enum<T>> extends TSelectWidget
{
	...
	@Nullable protected Function<Enum<T>, MutableComponent> enumValueToLabel;
	...
	public TSelectEnumWidget(int x, int y, int width, int height,
			Class<? extends Enum<T>> enumType,
			@Nullable Function<Enum<T>, MutableComponent> enumValueToLabel,
	 ...
	 */
	@Nullable
	public Function<Enum<T>, MutableComponent> getEnumValueToLabel() { return this.enumValueToLabel; }
