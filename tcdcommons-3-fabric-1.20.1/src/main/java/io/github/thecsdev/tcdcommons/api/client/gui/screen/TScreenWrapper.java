 ...
 * 
 * <p><b>Important:</b><br/>
 * If you wish to implement listener interfaces such as {@link StatsListener},
...
public @Virtual class TScreenWrapper extends Screen
{
	...
	// --------------------------------------------------
	public final @Override boolean mouseScrolled(double mouseX, double mouseY, double amount)
	{
		//Screen takes priority here, as its elements are rendered on top of TElement-s
		if(super.mouseScrolled(mouseX, mouseY, amount))
			return true;
		//if the Screen doesn't handle it, forward it to TScreen
		return input(ofMouseScroll(mouseX, mouseY, amount));
	}
	// --------------------------------------------------
	/**
