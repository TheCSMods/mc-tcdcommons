...
public final class TInputContext
{
	...
	private @Nullable Double scrollAmount;
	...
	public final @Nullable Double getScrollAmount() { return this.scrollAmount; }
	...
	public static TInputContext ofMouseScroll(double mouseX, double mouseY, double scrollAmount)
	{
