	...
	public void render(TDrawContext pencil, int mouseX, int mouseY, float deltaTime)
	{
	    ...
	    if(this.showMessage)
	    {
	    	if(textAlignment != HorizontalAlignment.CENTER)
	    		pencil.drawTextWithShadow(textRenderer, getMessage(), this.x + tX, this.y + tY, GuiUtils.applyAlpha(0xE0E0E0, alpha));
	    	else
	    		pencil.drawCenteredTextWithShadow(textRenderer, getMessage(), this.x + tX, this.y + tY, GuiUtils.applyAlpha(0xE0E0E0, alpha));
	    }
	}
	// ==================================================
}