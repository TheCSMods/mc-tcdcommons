...
public @Virtual class TitleBar extends TRefreshablePanelElement
{
	 ...
	 * @see #addSquareButton(Component, Consumer)
	 */
	...
	{
		public TitleBarSquareButton(int x, int y, int width, int height, Component text, Consumer<TButtonWidget> onClick) { super(x, y, width, height, text, onClick); }
		public TitleBarSquareButton(int x, int y, int width, int height, Component text) { super(x, y, width, height, text); }
	...
	{
		/**
		 * Returns the {@link Component} that should be shown on the {@link TitleBar}.
		 */
