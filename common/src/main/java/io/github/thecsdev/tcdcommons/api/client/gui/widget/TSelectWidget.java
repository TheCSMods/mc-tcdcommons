...
public @Virtual class TSelectWidget<T extends TSelectWidget.Entry> extends TButtonWidget implements Iterable<T>
{
	...
	(int x, int y, int width, int height, Component text, T... entryTypeClassGetter)
	{
	...
	public static final class SimpleEntry implements Entry, ITextProviderSetter
	{
		...
		public SimpleEntry(Component text) { this(text, null); }
		...
		public final void setTooltip(Component tooltipText) { setTooltip(Tooltip.create(tooltipText)); }
