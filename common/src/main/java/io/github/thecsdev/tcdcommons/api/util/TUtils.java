...
public final class TUtils
{
	...
	// ==================================================
	/**
	 * Throws a {@link ReportedException}.
	 ...
	 * @throws ReportedException Always.
	 */
	public static void throwCrash(String message, Throwable cause) throws ReportedException
	{
		final var exc = new ReportedException(new CrashReport(message, cause));
		throw exc;
	}
	// --------------------------------------------------
	/**
	...
	{
		return UUIDUtil.createOfflinePlayerUUID(nickname);
	}
	// --------------------------------------------------
	/**
