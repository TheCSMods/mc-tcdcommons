...
public final class CachedResourceManager
{
	 ...
	 */
	@Internal static final Cache<ResourceLocation, CachedResource<?>> RESOURCE_CACHE;
	 ...
	 */
	@Internal static final Cache<ResourceLocation, Exception> RECENT_EXCEPTIONS;
	 ...
	 */
	@Internal static final Cache<ResourceLocation, LinkedBlockingDeque<IResourceFetchTask<?>>> CURRENT_TASKS;
	// ==================================================
	...
	static
	{
		...
		MAID_SCHEDULER.scheduleAtFixedRate(() -> cleanUp(), 1, 180, TimeUnit.MINUTES);
		...
		RESOURCE_CACHE = CacheBuilder.newBuilder()
				...
				.weigher((Weigher<ResourceLocation, CachedResource<?>>)
	 ...
	 * @param resourceId The unique {@link ResourceLocation} of the resource being obtained.
	...
	public static final <R> void getResourceAsync(
			final ResourceLocation resourceId,
			final IResourceFetchTask<R> task) throws NullPointerException
	{ getResource(resourceId, task, true); }
	
	/**
	 * Same as {@link #getResourceAsync(ResourceLocation, IResourceFetchTask)}, except all
			...
			final boolean isAsync) throws NullPointerException
	{
		...
		//check for any recent exceptions or cached resources related to this request
		{
			...
			if(recentException != null)
			{
				...
				if(isAsync) mc.executeIfPossible(r); else r.run();
				return;
			}
	 ...
	 * @param resourceId The unique {@link ResourceLocation} of the resource being cached.
	 * @param cachedResource The {@link CachedResource} being added to the {@link #RESOURCE_CACHE}.
	 * @throws NullPointerException If an argument is {@code null}.
	 */
	public static final void forceCache(ResourceLocation resourceId, CachedResource<?> cachedResource)
	 ...
	 * {@link ResourceLocation} will be ignored and overridden.
	 * @throws NullPointerException If an argument is {@code null}.
	 */
	public static final void forceCache(ResourceLocation resourceId, CachedResource<?> cachedResource, boolean overrideExisting)
			throws NullPointerException
	{
		Objects.requireNonNull(resourceId);
	 ...
	 * @param resourceId The unique {@link ResourceLocation} of the resource being invalidated.
	 ...
	 * @throws NullPointerException If an argument is {@code null}.
	 */
	public static final void forceInvalidate(ResourceLocation resourceId, boolean deleteCacheFiles) throws NullPointerException
	{
		Objects.requireNonNull(resourceId);
	 ...
	 * resource {@link ResourceLocation}, either on the RAM or on the user's drive.
	 * @param resourceId The {@link CachedResource}'s unique {@link ResourceLocation}.
	 * @throws NullPointerException If an argument is {@code null}.
	 */
	public static final boolean cachedResourceExists(ResourceLocation resourceId) throws NullPointerException
	{
