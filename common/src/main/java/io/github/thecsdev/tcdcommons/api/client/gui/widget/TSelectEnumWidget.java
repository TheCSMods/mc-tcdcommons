...
public @Virtual class TSelectEnumWidget<E extends Enum<E>> extends TSelectWidget<EnumEntry<E>>
{
	...
	public TSelectEnumWidget(int x, int y, int width, int height, Class<E> enumType, Component text)
	{
		//super
	 ...
	 * @apiNote To have your {@link Enum} entries display custom {@link Component} labels,
	...
	public static final class EnumEntry<E extends Enum<E>> implements TSelectWidget.Entry
	{
		...
		protected final Component enumText;
		...
		public final @Override Component getText() { return this.enumText; }
