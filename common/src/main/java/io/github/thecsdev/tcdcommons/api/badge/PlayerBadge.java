...
public abstract class PlayerBadge
{
	...
	// --------------------------------------------------
	private @Internal ResourceLocation __id = null; //caching for performance reasons
	
	/**
	 * Returns the {@link ResourceLocation} of this {@link PlayerBadge} in
	 ...
	 */
	public final Optional<ResourceLocation> getId()
	{
