...
@Internal final class CacheFileUtils
{
	...
	// --------------------------------------------------
	private static final Cache<ResourceLocation, ReentrantLock> RESOURCE_LOCKS;
	// ==================================================
	static
	{
	...
	// ==================================================
	/**
	 * Returns the {@link ReentrantLock} that corresponds to a given resource {@link ResourceLocation}.
	 ...
	 * {@link CachedResource}'s unique {@link ResourceLocation}.<br/>
	 ...
	 * {@link CachedResource}'s unique {@link ResourceLocation}.
	 */
	...
	public static final boolean trySaveCachedResource(ResourceLocation resourceId, CachedResource<?> resource)
	...
	public static final @Nullable <R> CachedResource<R> tryLoadCachedResource(
			ResourceLocation resourceId, Class<R> resourceType) throws NullPointerException
	{
		final var lock = getResourceLock(resourceId);
		lock.lock();
		try
