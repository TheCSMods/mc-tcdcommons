...
public @Virtual class TButtonWidget extends TClickableWidget implements ITextProviderSetter
{
	...
	public TButtonWidget(int x, int y, int width, int height, Component text) { this(x, y, width, height, text, null); }
	...
	// --------------------------------------------------
	public final @Nullable @Override Component getText() { return this.text; }
	public @Virtual @Override void setText(@Nullable Component text) { this.text = text; }
	// --------------------------------------------------
