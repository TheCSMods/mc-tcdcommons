...
{
	// ==================================================
	public static final Component TEXT_SAVE   = translatable("selectWorld.edit.save");
	public static final Component TEXT_CANCEL = translatable("gui.cancel");
	// --------------------------------------------------
	/**
	 ...
	 * such as {@link #addLabel(Component)} for example, and not after you invoke {@link #build(Runnable)}.
	 */
	...
	// --------------------------------------------------
	public final T addLabel(Component text) { addLabelB(text); return self(); }
	public @Virtual TLabelElement addLabelB(Component text)
	{
	...
	// --------------------------------------------------
	public final T addCheckbox(Component text, boolean value, Consumer<TCheckboxWidget> applyValue) { addCheckboxB(text, value, applyValue); return self(); }
	public @Virtual TCheckboxWidget addCheckboxB(Component text, boolean value, Consumer<TCheckboxWidget> applyValue)
	{
		final var n1 = nextPanelVerticalRect(this.targetPanel);
