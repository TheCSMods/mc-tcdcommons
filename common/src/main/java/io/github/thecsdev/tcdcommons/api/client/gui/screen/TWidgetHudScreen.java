 ...
 * to the {@link Gui} via {@link TClientRegistries#HUD_SCREEN}.
 */
@Experimental
public abstract class TWidgetHudScreen extends TScreen implements IParentScreenProvider
{
	...
	//
	protected final ResourceLocation hudScreenId;
	protected @Nullable Screen parent;
	// ==================================================
	public TWidgetHudScreen(Component title, ResourceLocation hudScreenId) throws NullPointerException
	{
		super(title);
	...
	// --------------------------------------------------
	/**
	 * Returns the {@link ResourceLocation} for this {@link TWidgetHudScreen}
	 * that is used in the {@link TClientRegistries#HUD_SCREEN} registry.
	 */
	public final ResourceLocation getHudScreenID() { return this.hudScreenId; }
