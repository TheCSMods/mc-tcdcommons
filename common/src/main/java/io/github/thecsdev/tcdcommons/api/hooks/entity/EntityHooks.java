...
public final class EntityHooks
{
	 ...
	 */
	public static GenericProperties<ResourceLocation> getCustomData(Entity entity)
	{
	 ...
	 * @throws NullPointerException When the {@link ResourceLocation} is null.
	 */
	@Deprecated //for inconsistency with GenericProperties
	public static <T> T getCustomDataEntryG(Entity entity, ResourceLocation entryId)
	{
	 ...
	 */
	@Deprecated //for inconsistency with GenericProperties
	public static <T> T setCustomDataEntryG(Entity entity, ResourceLocation entryId, T entryValue)
	{
		Objects.requireNonNull(entryId);
