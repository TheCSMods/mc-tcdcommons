...
public @Virtual class TTextFieldWidget extends TClickableWidget implements ITextProviderSetter
{
	...
	protected Component __displayText = literal("");
	protected int __displayTextWidth = 0;
	protected Component __placeholderText;
	// --------------------------------------------------
	 ...
	 * @see #getInput()
	 */
	public final @Deprecated @Override Component getText() { return this.__displayText; }
	public final @Deprecated @Override void setText(Component text) { setInput((text != null) ? text.getString() : ""); }
	//
	...
	public final void setInput(String text, boolean invokeEvent)
	{
		...
		this.__displayTextWidth = TCDCommonsClient.MC_CLIENT.font.width(this.__displayText);
		//invoke any events that need invoking
		if(invokeEvent)
			this.eTextChanged.invoker().invoke(this, this.__text);
	}
	//
	public final @Nullable Component getPlaceholderText() { return this.__placeholderText; }
	public final void setPlaceholderText(@Nullable Component text) { this.__placeholderText = text; }
	// --------------------------------------------------
	/**
