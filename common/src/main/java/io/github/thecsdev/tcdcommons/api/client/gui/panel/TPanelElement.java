...
public @Virtual class TPanelElement extends TElement
{
	 ...
	 */
	public final boolean getSmoothScroll() { return Minecraft.useFancyGraphics() && this.smoothScroll; }
	...
	public final void setHorizontalScrollAmount(double amount01)
	{
		...
		amount01 = Mth.clamp(amount01, 0, 1);
	...
	public final double getHorizontalScrollKnobSize01()
	{
		...
		return Mth.clamp(cnvW / Math.max(elmW, 1), 0, 1);
	}
