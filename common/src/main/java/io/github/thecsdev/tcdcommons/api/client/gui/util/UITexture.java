...
{
	// ==================================================
	public static final ResourceLocation TEXTURE_UV_DEBUG = ResourceLocation.fromNamespaceAndPath(getModID(), "textures/gui/uv_debug.png");
	// --------------------------------------------------
	private final @Nullable ResourceLocation textureId;
	private final Dimension textureSize;
	private final Rectangle textureUVs;
	// ==================================================
	public UITexture() { this(TEXTURE_UV_DEBUG); }
	public UITexture(ResourceLocation textureId) { this(textureId, 1, 1); }
	public UITexture(ResourceLocation textureId, int textureWidth, int textureHeight) { this(textureId, new Dimension(textureWidth, textureHeight)); }
	public UITexture(ResourceLocation textureId, Dimension textureSize) { this(textureId, textureSize, 0, 0, 1, 1); }
	public UITexture(ResourceLocation textureId, Dimension textureSize, int u, int v, int uvW, int uvH) { this(textureId, textureSize, new Rectangle(u, v, uvW, uvH)); }
	public UITexture(ResourceLocation textureId, int textureWidth, int textureHeight, int u, int v, int uvW, int uvH) { this(textureId, new Dimension(textureWidth, textureHeight), new Rectangle(u, v, uvW, uvH)); }
	public UITexture(ResourceLocation textureId, Rectangle textureUVs) { this(textureId, new Dimension(256, 256), textureUVs); }
	...
	public final ResourceLocation getTexture() { return this.textureId; }
	
	/**
	 * Returns the texture's resource {@link ResourceLocation}.
	 */
	public final ResourceLocation getTextureID() { return this.textureId; }
	// --------------------------------------------------
	/**
	 ...
	 * @param pencil The {@link GuiGraphics}.
