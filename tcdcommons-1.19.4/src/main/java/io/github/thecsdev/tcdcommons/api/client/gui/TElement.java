...
public abstract class TElement extends TDrawableHelper implements TParentElement
{
	...
	/**
	 * The local z-index aka z-offset.<br/>
	 * Note that {@link #getZIndex()} accounts for {@link #parent}'s z-offset as well.
	 * @see #getZIndex()
	 * @see #getZOffset()
	 */
	 ...
	 */
	public final @Nullable Text getTooltip() { return this.tooltip; }
	
	/**
	 * Sets the {@link #getTooltip()} {@link Text} of this {@link TElement}.
	 * @param tooltip The new tooltip {@link Text}.
	 */
	public void setTooltip(@Nullable Text tooltip) { this.tooltip = tooltip; }
	// ==================================================
	/**
	...
	@Override
	public final double getZIndex() { return (getTParent() != null ? getTParent().getZIndex() : 0) + getZOffset(); }
	 ...
	 */
	public abstract void render(MatrixStack matrices, int mouseX, int mouseY, float deltaTime);
	 ...
	 * <br/>
	 * See {@link #render(MatrixStack, int, int, float)}.
	 * @param matrices The {@link MatrixStack}.
	 * @param mouseX The X mouse cursor position on the {@link TScreen}.
	 * @param mouseY The Y mouse cursor position on the {@link TScreen}.
	 * @param deltaTime The time elapsed since the last frame.
	 ...
	 * @param deltaTime The time elapsed since the last frame.
	 */
	public void drawTElementText(MatrixStack matrices, Text text, HorizontalAlignment alignment, float deltaTime)
	{
	 ...
	 * @param deltaTime The time elapsed since the last frame.
	 */
	public void drawTElementText(MatrixStack matrices, Text text, HorizontalAlignment alignment, int color, float deltaTime)
	{
	 ...
	 * @param deltaTime The time elapsed since the last frame.
	 */
	public void drawTElementText(MatrixStack matrices, Text text, HorizontalAlignment alignment, int color, int padding, float deltaTime)
	{
		...
		if(text != null)
		{
			...
			{
				case CENTER:
					drawCenteredTextWithShadow(matrices, txtR, text, x + width / 2, y, color);
					break;
				case LEFT:
					drawTextWithShadow(matrices, txtR, text, x + padding, y, color);
					break;
				case RIGHT:
					drawTextWithShadow(matrices, txtR, text, x + width - padding - txtR.getWidth(text.getString()), y, color);
					break;
				default: return;
			}
		}
