...
public class TSelectWidget extends TButtonWidget
{
	...
	// --------------------------------------------------
	public TSelectWidget addDropdownOption(Component label, Runnable onSelect) { return addDropdownOption(label, onSelect, null); }
	...
	protected class SWEntry
	{
		...
		public SWEntry(Component message, Runnable onClick) { this(message, onClick, null); }
