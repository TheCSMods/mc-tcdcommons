...
public class TDynamicSliderWidget extends AbstractTSliderWidget
{
	 ...
	 * is the text shown on the slider alongside it's value.
	 */
	public Component getLabel() { return this.label; }
	...
	public ChatFormatting getValueFormatting() { return this.valueFormatting; }
	...
	{
		if(valueFormatting == null) valueFormatting = ChatFormatting.WHITE;
		int val = Mth.clamp((int)(this.value * 100), 0, 100);
