...
public class TMenuBarPanel extends TPanelElement
{
	 ...
	 * {@link TMenuBarPanelItem} element.
	 */
	protected int nextW(Component label)
	{
		if(label == null) return 40;
		return getTextRenderer().width(label) + 15;
	}
	// ==================================================
	/**
	 ...
	 */
	public TMenuBarPanelItem addItem(Component label)
	{
	...
	{
		// ----------------------------------------------
		protected TMenuBarPanelItem(Component label)
		{
			//construct
