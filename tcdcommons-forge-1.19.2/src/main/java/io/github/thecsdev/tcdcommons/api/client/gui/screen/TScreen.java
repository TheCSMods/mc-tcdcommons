...
public abstract class TScreen extends Screen implements TParentElement
{
	...
	// --------------------------------------------------
	public final @Override void onClose() { close(); } //forge port: onClose -> close
	public @SuppressWarnings("resource") void close()
	{
	...
	*/
	 ...
	 */
	public Font getTextRenderer() { return this.font; }
	 ...
	 * Called by {@link #render(PoseStack, int, int, float)}.
	 * @param matrices The {@link PoseStack}.
	 * @param mouseX The X mouse cursor position on the {@link Screen}.
	 * @param mouseY The Y mouse cursor position on the {@link Screen}.
	 * @param delta The time elapsed since the last render.
	 ...
	 */
	protected void renderChildTElement(PoseStack matrices, int mouseX, int mouseY, float delta,
			TElement child, boolean isPreRender)
	{
		...
		GuiUtils.applyScissor(minecraft, parentBox.x, parentBox.y, parentBox.width, parentBox.height, () ->
		{
	 ...
	 * See {@link #renderChildTElement(PoseStack, int, int, float, TElement, boolean)}.<br/>
	 * <br/>
	...
	public void resetScissors()
	{
		...
		GuiUtils.enableScissor(minecraft,
	...
	@Override
	@Deprecated
	protected final <T extends GuiEventListener & NarratableEntry> T addWidget(T drawableElement) { return drawableElement; }
	...
	@Override
	@Deprecated
	protected final <T extends Widget> T addRenderableOnly(T drawable) { return drawable; }
	...
	@Override
	@Deprecated
	protected final  <T extends GuiEventListener & Widget & NarratableEntry> T addRenderableWidget(T selectable) { return selectable; }
	...
	@Override
	@Deprecated
	public final List<? extends GuiEventListener> children() { return Lists.newArrayList(); }
	 ...
	 */
	@Override
	public final GuiEventListener getFocused() { return super.getFocused(); }
	...
	@Override
	@Deprecated
	public final void setFocused(GuiEventListener focused)
	{
